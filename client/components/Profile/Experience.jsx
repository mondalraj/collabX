...
const Experience = ({
  ...
  useEffect(() => {
    setFormData({ ...formData, workExperience: experience });
  }, [experience]);
  return (
    <>
                ...
                <form>
                  ...
                  <div className="justify-around mt-2 form2 sm:flex">
                    <div className="pl-2">
                      ...
                      <div>
                        <input
                          className=" h-9 w-[70vw] sm:w-[25vw]  bg-[#fff] text-black rounded-md border border-gray-300  py-2 px-3 text-sm placeholder:text-gray-500 focus:outline-none focus:ring-1 focus:ring-gray-400 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 dark:border-gray-700 dark:focus:ring-gray-400 dark:focus:ring-offset-gray-900"
                          type="date"
