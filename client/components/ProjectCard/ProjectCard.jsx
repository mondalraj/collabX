...
const ProjectCard = ({ name, about, skills, id, index, isFeatured }) => {
  return (
    <div>
      <div
        className="profileCard  max-h-[60vh] sm:max-h-[70vh] rounded-lg w-[100%] md:w-[95%] mt-[1rem] mb-[2rem] pb-[1rem] pt-[1rem] text-sm
        ...
        <div className="flex justify-around profileCardUpperSection">
          <div className="h-12 socialIcons">
            <h3 className="text-[#fff] text-2xl">
              {isFeatured && <span className="text-orange-300"> ★</span>}
              &nbsp;
              {name}
            </h3>
          </div>
